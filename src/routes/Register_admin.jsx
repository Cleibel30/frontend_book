...
export const Register_admin = () => {
  ...
  const form = (e) => {
    ...
    const {user_name, email, password, password_admin} = formState

    if(user_name && email && password && password_admin) register(formState, "register/admin", "/ladmin")
  }
        ...
        <div className="row justify-content-center aling-item-center">
          <div className="col-lg-6 col-md-8 col-sm-12">
            <form action="" onSubmit={form} className='container-fluid bg-light w-100 p-3 rounded shadow'>
              ...
              <div classNameName="row">
                <div classNameName="col-lg-6">
                  <label for="exampleInputPassword2" class="form-label">Contraseña de administrador</label>
                  <input onChange={onInputChange} type="password" name='password_admin' class="form-control" id="exampleInputPassword2" placeholder='Ingresa la contraseña'/>
                </div>
              </div>
